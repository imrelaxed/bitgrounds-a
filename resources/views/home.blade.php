...
<div class="text-center">
                    <h2>Hey <span class="text-primary"> {{ ucfirst(Auth::user()->name) }}</span></h2>
...
<ul class="manage-bar">
    <li><a href="#"><span class="menu-icon fa fa-home"></span> Direct Admin </a></li>

    <li><a href="#"><span class="menu-icon fa fa-home"></span> Web Mail </a></li>

    <li><a href="#"><span class="menu-icon fa fa-home"></span> Password Change </a></li>
    ...
    <div class="col-xs-8 gutter__padding">
        ...
        <a href="" class="btn-block btn btn-info"><span class="fa fa-home"></span>  Nameserver / DNS Details</a>
        <a href="" class="btn-block btn btn-info"><span class="fa fa-home"></span>  Administration Details</a>
        <a href="" class="btn-block btn btn-info"><span class="fa fa-home"></span>  File Upload Details</a>
        <a href="" class="btn-block btn btn-info"><span class="fa fa-home"></span>  Email Setup Instructions</a>
